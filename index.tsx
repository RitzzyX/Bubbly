      ...
      <div className="min-h-screen bg-[#FCF6F2] py-24 px-6 md:px-12 flex justify-center overflow-y-auto">
        <article className="max-w-3xl w-full bg-white p-10 md:p-24 shadow-[0_30px_90px_-20px_rgba(45,41,38,0.1)] rounded-[3rem] border border-[#F2E8E1] relative">
          ...
          <div className="letter-content space-y-8 text-[#433939] leading-[1.8] font-light text-lg md:text-xl tracking-tight">
            ...
            <p>Before you, life was moving. After you, life started <span className="text-[#BC5449] italic font-normal">meaning</span> something. You walked into my world so quietly, like a gentle breeze, but somehow you became the air I breathe. I didn’t even realize when you stopped being “someone I love” and became “someone I can’t imagine a single day without.”</p>
            ...
            <p>I love your overthinking. I love your mood swings. I love the way you get emotional. I love the way you pretend to be strong but just want reassurance. I love the way you act tough but melt with affection. I love your clinginess. I love your independence. I love your softness. I love your fire. <span className="block mt-4 italic text-[#9E7676]">You are my favorite contradiction.</span></p>
            ...
            <p>You are not just my girlfriend. You are my peace. You are my comfort. You are my home. And home is not a place. <span className="text-[#BC5449] font-medium italic">It’s you.</span></p>
          ...
          <div className="mt-24 pt-16 border-t border-[#F2E8E1] flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
            <div>
              ...
              <p className="text-4xl font-serif text-[#2D2926] font-bold tracking-tight">{NICKNAMES.SIDHU}</p>
  ...
  return (
    <main className="selection:bg-[#F4E4E1] selection:text-[#BC5449]">
      ...
      <footer className="fixed bottom-8 left-0 w-full text-center pointer-events-none z-0">
        <p className="text-[10px] uppercase tracking-[0.6em] text-[#BC5449]/30 font-black">Handcrafted for {NICKNAMES.HER}</p>
      </footer>
    </main>
  );
};
